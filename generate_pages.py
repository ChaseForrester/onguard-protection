...
SERVICES = [
    {
        ...
        "img_w": 1170,
        "img_h": 1169,
        "alt": "OnGuard Protection crowd controllers managing patrons at a licensed NSW outdoor event",
        ...
        "bullets": [
            "Class 1C crowd controllers for licensed venues",
    ...
    },
    {
        ...
        "img_w": 1440,
        "img_h": 1080,
        "alt": "OnGuard Protection event security team on the ground at the Nowra Annual Rodeo in NSW",
    ...
    },
    {
        ...
        "img_w": 1376,
        "img_h": 768,
        "alt": "Uniformed OnGuard Protection static guard monitoring a commercial site access point in New South Wales",
    ...
    },
    {
        ...
        "img_w": 1376,
        "img_h": 768,
        "alt": "OnGuard Protection mobile patrol vehicle conducting an after-hours security check at a NSW industrial site",
    ...
    },
    {
        ...
        "img_w": 1376,
        "img_h": 768,
        "alt": "OnGuard Protection corporate security concierge at a NSW commercial lobby reception desk",
    ...
    },
    {
        ...
        "img_w": 1376,
        "img_h": 768,
        "alt": "OnGuard Protection officer protecting high-value plant and compound assets at a NSW industrial site",
...
def write_location(loc: dict) -> None:
    ...
    hero_meta = {
        ...
        "service_static": (1376, 768, "OnGuard Protection static guard on a New South Wales commercial site"),
        "service_patrol": (1376, 768, "OnGuard Protection mobile patrol officer checking a NSW industrial site after hours"),
        "service_commercial": (1376, 768, "OnGuard Protection corporate security presence at a NSW commercial building"),
        "service_event": (1376, 768, "OnGuard Protection event security deployment at a New South Wales venue"),
    }
...
def write_tech() -> None:
    ...
    images = [
        ...
        ("assets/service_static.jpg", "OnGuard Protection static security guard on a NSW site", 1376, 768),
        ("assets/service_patrol.jpg", "OnGuard Protection mobile patrol at a NSW industrial site", 1376, 768),
        ("assets/service_commercial.jpg", "OnGuard Protection corporate security concierge in NSW", 1376, 768),
        ("assets/service_event.jpg", "OnGuard Protection event and asset protection deployment in NSW", 1376, 768),
    ]
    img_xml = "\n".join(
        f'''  <url>
    <loc>{SITE}/</loc>
